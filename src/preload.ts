...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    exportEnvVars: (vars: { name: string, value: string, isProtected?: boolean, groupName?: string }[], format: string, isMasked: boolean, mode?: string, extraParam?: string) => ipcRenderer.invoke('export-env-vars', vars, format, isMasked, mode, extraParam),
